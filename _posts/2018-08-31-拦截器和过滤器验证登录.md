...
date:	    2018-08-31
author:	    L
header-img: "img/post/2018-08/31.jpg"
tags:
    - Spring MVC
    - Java Web
    - Spring
...
之前的版本是 [v0.2.1](https://github.com/lihanxiang/Registration-login-interface2/tree/v0.2.1) 保持登录状态的版本，这一次 v0.2.2 是对验证登录过程的一个更新，用拦截器和过滤器来进行，发现这种方式省去了一些逻辑的实现

### [Registration-login-interface2](https://github.com/lihanxiang/Registration-login-interface2)
