...
date:	    2018-08-26
author:	    L
header-img: "img/post/2018-08/26.jpg"
tags:
    - Spring MVC
    - Java Web
    - Spring
...
> 之前有做过一个练手的[商品管理的小项目](https://github.com/lihanxiang/p-m)，然后用 [SSM 重构](https://github.com/lihanxiang/new-p-m)了，接下来又做了一个[模拟注册登录的界面](https://github.com/lihanxiang/Registration-login-interface)，然后前两天用 [SSM 重构](https://github.com/lihanxiang/Registration-login-interface2)了这个项目的后台代码，修改了一点前端页面，后台功能不变
>
